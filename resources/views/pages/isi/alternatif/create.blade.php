<x-layouts.app-dashboard title="{{ $title }}">
    ...
    <x-molecules.breadcrumb>
        ...
        <li aria-current="page">
            <div class="flex items-center">
                <x-atoms.svg.arrow-right />
                <span class="mx-2 text-base font-medium text-gray-500">Tambah Petshop</span>
            </div>
        </li>
    </x-molecules.breadcrumb>

    <div class="mx-auto my-8 w-8/12">
        <h4 class="mb-6 text-2xl font-semibold text-gray-900">Tambah Petshop</h4>
        ...
        <form class="mt-8 space-y-6" action="{{ route('alternatif.store') }}" method="POST">
            ...
            <div>
                ...
                <input class="@error('nama_alternatif') border-red-500 @enderror field-input-slate w-full" name="nama_alternatif"
                    type="text" value="{{ old('nama_alternatif') }}" placeholder="Sebutkan nama petshop" required>
            ...
            <div>
                ...
                <input class="@error('jam_buka') border-red-500 @enderror field-input-slate w-full"
                    name="jam_buka" type="time" value="{{ old('jam_buka') }}" required>
            ...
            <div>
                ...
                <input class="@error('jam_tutup') border-red-500 @enderror field-input-slate w-full"
                    name="jam_tutup" type="time" value="{{ old('jam_tutup') }}" required>
            ...
            <div>
                ...
                <input class="@error('alamat') border-red-500 @enderror field-input-slate w-full" name="alamat"
                    type="text" value="{{ old('alamat') }}" placeholder="Sebutkan alamat" required>
            ...
            <div>
                ...
                <input class="@error('rating') border-red-500 @enderror field-input-slate w-full" name="rating"
                    type="text" value="{{ old('rating') }}" placeholder="Berikan rating" required>
            ...
            <div>
                ...
                <input class="@error('deskripsi') border-red-500 @enderror field-input-slate w-full" name="deskripsi"
                    type="text" value="{{ old('deskripsi') }}" placeholder="Berikan deskripsi" required>
