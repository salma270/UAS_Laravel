                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative -ml-px inline-flex cursor-default items-center border border-gray-300 bg-indigo-600 px-4 py-2 text-sm font-medium leading-5 text-white">{{ $page }}</span>
                                    </span>
                                @else
